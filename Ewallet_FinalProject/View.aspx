<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="View.aspx.cs" Inherits="Ewallet_FinalProject.View" %>
            ...
            <br />
                ...
                <br />
                    ...
                    <div style="font-size: large; width: 557px; margin: auto; text-align: left">
                       ...
                       <br /><br />
                        <div id="Div" runat="server" style="font-size: large; width: 557px; margin: auto; text-align: left" Visible="false">
                        &emsp;Sender Account #:&emsp;
                        <div style="text-align: right; font-size: 25px;">
                            <asp:Label ID="SenLbl" runat="server" Text=""></asp:Label> &emsp;
                        </div>
                        <br />
                        &emsp;Recipient Account #:&emsp;
                        <div style="text-align: right; font-size: 25px;">
                            <asp:Label ID="RecLbl" runat="server" Text=""></asp:Label>&emsp;
                        </div>
                        <br />
                    </div>
                    </div>
